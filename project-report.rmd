...
Valuable revenue stream (commercial fruit) (Yates et. al., 2007)
...
The trees can provide shade for chicken in summer, and shelter from wind in the winter (Bestman et. al., 2018)

The poultry can promote nutrient cycling, reduce scab and pest/weed control (Bestman et. al., 2018)

Reduce point load of nutrients because hens spread over a larger surface (Smith et al. 2013)
...
Few studies on disease and pest reduction resulting in (and unclear observations) estimations of inputs (Yates et. al., 2007)
