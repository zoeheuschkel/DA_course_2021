...
important thoughts: finish the avian influenca, finsish the apple subsystem, then talk about the interaction, then say it would have been clearer to only include the aspects which were affected by chicken instead of all the aspects of growing apple trees (idea was to compare also the scale, and we can see that the direct benefits of keeping chicken, direct benefits of growing apple, synergies and theoretical trade-offs even though not implemended in this version). Luedeling mentioned that the should'nt have excluded the yield effect of chicken, maybe even negative (chicken might harm some trees). aspect of gradual influence of chicken not respected by our model
